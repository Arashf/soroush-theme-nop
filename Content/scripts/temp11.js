...
function scrollToTop() {
  const elementdesktop = document.getElementById("scrollToTopDesktop")
  const elementMobile = document.getElementById("scrollToTopMobile")

  if (elementdesktop !== null && elementdesktop !== undefined) {
    elementdesktop.addEventListener("click", () => {
      document.body.scrollTop = 0
      document.documentElement.scrollTop = 0
    })
  }
  if (elementMobile !== null && elementMobile !== undefined) {
