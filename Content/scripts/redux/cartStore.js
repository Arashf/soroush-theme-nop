...
store.subscribe(() => {
    ...
    let subTotal = 
        this.priceFormat(data.OrderTotalResponseModel?.SubTotal) > 0 ? this.priceFormat(data.OrderTotalResponseModel?.SubTotal) : 0
    // qualifyPrice = this.priceFormat(data.OrderTotalResponseModel?.SubTotal)

       
       if(data.OrderTotalResponseModel?.SubTotal === null || data.OrderTotalResponseModel?.SubTotal === undefined 
    ...
    return ` <div class="w-full mt-auto sticky bottom-0 left-0">
          ...
          >
           <div class="w-full bg-[#e0e0e0] flex justify-center items-center gap-2 p-[10px] mt-2 rounded-[10px]">
                    ...
                    <span class="text-[15px] font-semibold"> 100,000</span>
...
<!--                       </span>-->
<!--                    </div>-->
<!--                    <div class="text-[15px] text-zinc-400 font-semibold">100,000-->
<!--                        <span> تومان</span>-->
<!--                    </div>-->
<!--                  </div> -->
<!--            </div>-->
